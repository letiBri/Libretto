...
#è meglio non avere istruzioni che eseguono codice oltre alle definizioni nei file che creo
# con il from importiamo più nomi indipendenti come Voto, Libretto
# posso scrivere anche
# import voto --> importo il nome del file e accedo alle varie classi con la notazione puntata
#usare la sintassi diversa in base alla necessità della libreria

#from voto import * # importa tutti i nomi in voto in maniera indipendente, è più ambiguo
...
#print(Lily._conome) #NOOOOO
#con _ avviso di cercare di non usare quell'attributo
# se voglio che una variabile non sia toccata da nessuno la indico con __

#print(Lily.__Person__prova) #NOOOOO

grifondoro = Casa("Grifondoro", [])
tassorosso = Casa("Tassorosso", [])  #posso usare [] perchè ho inserito un argomento default
